# Generated by Django 2.0.4 on 2018-05-29 05:59
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('imagen_descriptiva', models.FileField(upload_to=biblioteca_digital.models.update_imagen)),
                ('fecha_creacion', models.DateTimeField(default=datetime.datetime.now)),
                ('tema', models.PositiveSmallIntegerField(choices=[(1, 'formacion ciudadana'), (2, 'convivencia escolar'), (3, 'otros')], default=1)),
                ('archivo', models.FileField(upload_to=biblioteca_digital.models.update_filename)),
