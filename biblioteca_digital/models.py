...
class Recurso(models.Model):
    ...
    imagen_descriptiva = models.FileField(upload_to='imagenes/', null = False)
    fecha_creacion = models.DateTimeField(default=datetime.now)
    tema = models.PositiveSmallIntegerField(choices=TEMA_ALTERNATIVAS,default=1)
    archivo = models.FileField(upload_to='recursos/', null = False)
    ...
    def setValoracion(self, valoracionNueva):
        ...
        self.valoracionTotal = (self.valoracionTotal*(self.cant_valoracion-1) + valoracionNueva)/self.cant_valoracion
